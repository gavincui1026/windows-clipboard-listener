...
cmd = ["profanity", "--matching", "TXXXXXXXXXXXXXXX11111", "--suffix-count", "5", "--quit-count", "1"]
print("命令:", " ".join(cmd))
...
cmd = ["profanity", "--matching", "TXXXXXXXXXXXXXXX22222", "--suffix-count", "5", "--quit-count", "1", "--output", output_file]
print("命令:", " ".join(cmd))
